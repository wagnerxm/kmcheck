...
Adicionar testes unitários para a lógica de geometria e formatação, e testes E2E com Playwright para fluxos críticos. Ver [testes.md](testes.md) para detalhes.
